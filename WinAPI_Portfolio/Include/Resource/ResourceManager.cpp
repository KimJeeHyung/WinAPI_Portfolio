...
bool CResourceManager::CreateAniamtionSequence(const std::string& Name, CTexture* Texture)
{
	return m_AnimationManager->CreateAniamtionSequence(Name, Texture);
}

bool CResourceManager::CreateAniamtionSequence(const std::string& Name,
...
bool CResourceManager::CreateAniamtionSequenceFullPath(const std::string& Name,
...
bool CResourceManager::AddAnimationFrame(const std::string& Name, const Vector2& Start,
	const Vector2& End)
{
...
bool CResourceManager::LoadSound(const std::string& GroupName, const std::string& Name,
